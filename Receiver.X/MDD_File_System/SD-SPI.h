...
#define SD_CS SD_CS_LAT
#define SPI_INTERRUPT_FLAG_ASM  PIR5, 2
#define SPI_INTERRUPT_FLAG  PIR5bits.SPI2IF
...
//#define MILLISECDELAY   (uint16_t)      ((GetInstructionClock()/DELAY_PRESCALER/(uint16_t)1000) - DELAY_OVERHEAD)
...
uint8_t MDD_SDSPI_AsyncReadTasks(ASYNC_IO*);
uint8_t MDD_SDSPI_AsyncWriteTasks(ASYNC_IO*);
