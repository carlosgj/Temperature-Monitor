...
const int16_t DAYS_IN_MONTH[] = {-1, 31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};

// -1 is a placeholder for indexing purposes.
const int16_t DAYS_BEFORE_MONTH[] = {-1, 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334};
...
uint16_t days_before_year(uint16_t year){
...
uint8_t days_in_month(uint16_t year, uint8_t month){
    ...
    if(month < 1 || month > 12){
        printf("Assert failed: month not in range\n");
        return 0;
    }
